...
const ComprobanteConfirmacionModal = ({
  isOpen,
  onClose,
  onConfirm,
  formData,
  ...
  const tipoComprobante = tiposComprobante.find(t => t.id === formData.idTipoComprobante);
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div className="mt-4 border-t border-gray-200 py-4">
                  ...
                  <div className="mb-4 grid grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-sm font-bold text-gray-700 uppercase mb-1">Tipo Factura</h4>
                      <p className="text-sm text-gray-600">{tipoComprobante?.nombre || '-'}</p>
                    </div>
                    <div>
...
export default ComprobanteConfirmacionModal;
